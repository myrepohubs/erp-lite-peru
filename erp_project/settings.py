...
SECRET_KEY = 'django-insecure-w$=!h9v2*f=40tsvhgxv%*e*t-5uw*0$q5lb2ai_9#lu*v-*xp'
...
MIDDLEWARE = [
    ...
    'django_htmx.middleware.HtmxMiddleware', # Añadir aquí
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'erp_lite_db',
        'USER': 'erp_user',
        'PASSWORD': 'tu_password_segura', # ¡CAMBIA ESTO!
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
